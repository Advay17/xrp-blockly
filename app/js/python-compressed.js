...
(function (root, factory) {
    ...
    module$contents$Blockly$Python_Python.addReservedWords(
    ...
    module$contents$Blockly$Python_Python.ORDER_OVERRIDES = [
        ...
        [module$contents$Blockly$Python_Python.ORDER_LOGICAL_NOT, module$contents$Blockly$Python_Python.ORDER_LOGICAL_NOT],
    ...
    module$contents$Blockly$Python_Python.init = function (a) {
        ...
        for (var b = [], c = (0, $.module$exports$Blockly$Variables.allDeveloperVariables)(a), d = 0; d < c.length; d++) b.push(this.nameDB_.getName(c[d], $.module$exports$Blockly$Names.Names.DEVELOPER_VARIABLE_TYPE) + " = None");
    ...
    module$contents$Blockly$Python_Python.scrub_ = function (a, b, c) {
        ...
        if (!a.outputConnection || !a.outputConnection.targetConnection) {
            ...
            for (var f = 0; f < a.inputList.length; f++)
                a.inputList[f].type === $.module$exports$Blockly$inputTypes.inputTypes.VALUE && (e = a.inputList[f].connection.targetBlock()) && (e = this.allNestedComments(e)) && (d += this.prefixLines(e, "# "));
        }
    ...
    $.Blockly.Python.text_join = function (a) {
        switch (a.itemCount_) {
            ...
            case 2:
                ...
                return [module$contents$Blockly$Python$texts_forceString(b)[0] + " + " + module$contents$Blockly$Python$texts_forceString(a)[0], $.Blockly.Python.ORDER_ADDITIVE];
            default:
                b = [];
    ...
    $.Blockly.Python.procedures_defreturn = function (a) {
        for (var b = [], c = a.workspace, d = (0, $.module$exports$Blockly$Variables.allUsedVarModels)(c) || [], e = 0, f; (f = d[e]); e++)
            (f = f.name), -1 === a.getVars().indexOf(f) && b.push($.Blockly.Python.nameDB_.getName(f, $.module$exports$Blockly$Names.NameType.VARIABLE));
        ...
        c = b.length ? $.Blockly.Python.INDENT + "global " + b.join(", ") + "\n" : "";
        ...
        e = "";
        $.Blockly.Python.INFINITE_LOOP_TRAP && (e = $.Blockly.Python.prefixLines($.Blockly.Python.injectId($.Blockly.Python.INFINITE_LOOP_TRAP, a), $.Blockly.Python.INDENT));
    ...
    $.Blockly.Python.procedures_callreturn = function (a) {
        for (var b = $.Blockly.Python.nameDB_.getName(a.getFieldValue("NAME"), $.module$exports$Blockly$Names.NameType.PROCEDURE), c = [], d = a.getVars(), e = 0; e < d.length; e++)
    ...
    $.Blockly.Python.math_number_property = function (a) {
        var b = {
                EVEN: [" % 2 == 0", $.Blockly.Python.ORDER_MULTIPLICATIVE, $.Blockly.Python.ORDER_RELATIONAL],
                ODD: [" % 2 == 1", $.Blockly.Python.ORDER_MULTIPLICATIVE, $.Blockly.Python.ORDER_RELATIONAL],
                WHOLE: [" % 1 == 0", $.Blockly.Python.ORDER_MULTIPLICATIVE, $.Blockly.Python.ORDER_RELATIONAL],
                POSITIVE: [" > 0", $.Blockly.Python.ORDER_RELATIONAL, $.Blockly.Python.ORDER_RELATIONAL],
                NEGATIVE: [" < 0", $.Blockly.Python.ORDER_RELATIONAL, $.Blockly.Python.ORDER_RELATIONAL],
                DIVISIBLE_BY: [null, $.Blockly.Python.ORDER_MULTIPLICATIVE, $.Blockly.Python.ORDER_RELATIONAL],
                PRIME: [null, $.Blockly.Python.ORDER_NONE, $.Blockly.Python.ORDER_FUNCTION_CALL],
            },
        ...
        var d = b.next().value,
            e = b.next().value;
        b = b.next().value;
        e = $.Blockly.Python.valueToCode(a, "NUMBER_TO_CHECK", e) || "0";
        if ("PRIME" === c)
            ($.Blockly.Python.definitions_.import_math = "import math"),
            ...
            if ("0" === a) return ["False", $.Blockly.Python.ORDER_ATOMIC];
            a = e + " % " + a + " == 0";
        } else a = e + d;
        return [a, b];
    };
    ...
    $.Blockly.Python.controls_repeat_ext = function (a) {
        ...
        return "for " + $.Blockly.Python.nameDB_.getDistinctName("count", $.module$exports$Blockly$Names.NameType.VARIABLE) + " in range(" + b + "):\n" + c;
    };
    ...
    $.Blockly.Python.controls_for = function (a) {
        ...
        if ((0, $.module$exports$Blockly$utils$string.isNumber)(c) && (0, $.module$exports$Blockly$utils$string.isNumber)(d) && (0, $.module$exports$Blockly$utils$string.isNumber)(e))
            ...
            var k = function (l, m) {
                (0, $.module$exports$Blockly$utils$string.isNumber)(l)
                    ? (l = Number(l))
                    : l.match(/^\w+$/)
                    ? (l = "float(" + l + ")")
                    : ((m = $.Blockly.Python.nameDB_.getDistinctName(b + m, $.module$exports$Blockly$Names.NameType.VARIABLE)), (g += m + " = float(" + l + ")\n"), (l = m));
                return l;
            };
            c = k(c, "_start");
            d = k(d, "_end");
    ...
    $.Blockly.Python.lists_setIndex = function (a) {
        ...
        switch (d) {
            ...
            case "RANDOM":
                $.Blockly.Python.definitions_.import_random = "import random";
                b.match(/^\w+$/) ? (a = "") : ((a = $.Blockly.Python.nameDB_.getDistinctName("tmp_list", $.module$exports$Blockly$Names.NameType.VARIABLE)), (d = a + " = " + b + "\n"), (b = a), (a = d));
